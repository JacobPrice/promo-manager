...
class AssetController {
    public function scripts() {
        ...
        wp_enqueue_script( 'swiper-slider-script', config('plugin.url') . '/resources/assets/scripts/swiper.js', [], '', true );

    }
    public function styles() {
        wp_enqueue_style( 'swiper-styles', 'https://unpkg.com/swiper/swiper-bundle.min.css' );
        wp_enqueue_style( 'swiper-slider-style', config('plugin.url') . '/resources/assets/styles/swiper.css', [] );
    }
