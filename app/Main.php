...
class Main
{
  ...
  public function admin_init_cb()
  {
    ...
    // register_setting('test-lpd', 'testrun_visitor_name');
    // register_setting('test-lpd', 'testrun_visitor_company');
  ...
  public function admin_menu_cb()
  {
    ...
    add_menu_page('Test Run Admin Page', 'Test LPD', 'manage_options', 'test-lpd', ['\LpdPromo\View', 'render_menu_page'], 'dashicons-schedule', 3);
  }
